...
Things we care about:
    ...
    Job sequence for each model in an MDB.
"""
class ABQMetadata:
    ...
    # type: (str) -> None
        ...
        self.record[model_name]["job_names"] = []
    ...
    def get_last_part_name(self, model_name):
    # type: (str) -> str

        return self.record[model_name]["part_names"][-1]

    
    def add_job_to_model(self, model_name, job_name):
    # type: (str, str) -> None

        self.record[model_name]["job_names"].append(job_name)


    def get_last_job_name(self, model_name):
    # type: (str) -> str

        return self.record[model_name]["job_names"][-1]
